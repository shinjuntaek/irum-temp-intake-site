...
const profileRequired = [
  ...
  "const CLIENT_BUILD_ID='secondary-consultation-crm-fields-20260827-5'",
  "activeDraftSave=null",
  "const saveDraft=async({retryConflict=true}={})=>",
  "if(previous)await previous",
  "const currentPayload={...form,privacyConsent:form.privacyConsent===true,healthSensitiveConsent:form.healthSensitiveConsent===true,documentDeferred:form.documentDeferred===true}",

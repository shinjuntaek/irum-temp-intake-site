(() => {
  ...
  window.installIrumCrmRuntime = () => {
    ...
    const render = (item) => {
      ...
      if (profileCopy && crmCompletion) profileCopy.append(crmCompletion);

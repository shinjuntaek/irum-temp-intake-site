(() => {
  ...
  window.installIrumCrmRuntime = () => {
    ...
    const render = (item) => {
      ...
      document.querySelector(".layout")?.classList.add("crm-reference-layout");

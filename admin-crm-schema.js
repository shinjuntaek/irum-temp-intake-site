(() => {
  ...
  const primary = [
    ...
    field("primary-body-male", "1차 기본정보", "체형", "primary", "bodyType", select(["마른 편", "보통", "슬림탄탄", "근육질", "통통한 편"]), { gender: "male" }),
  ...
  const maleSecondary = [
    ...
    field("male-car-model", "자산", "차량 상세", "secondary", "carModel", text("차종 · 연식"), { aliases: ["car_model"], when: ({ get }) => ["Y", "있음"].includes(String(get("car") || "")) }),
  ...
  window.IRUM_CRM_REGISTRY = Object.freeze({
    version: "field-setup-v1-20260828",
    primary,
